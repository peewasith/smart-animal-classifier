...
if not os.path.exists(model_json_path) or not os.path.exists(model_weights_path):
    ...
    gdown.download("https://drive.google.com/uc?id=FILE_ID_JSON", model_json_path, quiet=False)
    gdown.download("https://drive.google.com/uc?id=FILE_ID_H5", model_weights_path, quiet=False)
