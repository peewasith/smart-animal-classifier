...
if not os.path.exists(model_json_path) or not os.path.exists(model_weights_path):
    ...
    # แทน FILE_ID_JSON / FILE_ID_H5 ด้วย ID ของไฟล์คุณ
    gdown.download("https://drive.google.com/file/d/1zPDPfB0LKsXZHoog4m_9BRUWVr7HFkHI/view?usp=sharing", model_json_path, quiet=False)
    gdown.download("https://drive.google.com/file/d/12Xc4HEky4W68UxyZVDvsBGAkyeR_OyHK/view?usp=sharing", model_weights_path, quiet=False)
